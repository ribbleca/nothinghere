...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Digital DNA Color Palette - Adna's Unique Brand Colors
        primary: {
          50: "#f0f9ff",
          100: "#e0f2fe", 
          200: "#bae6fd",
      ...
      animation: {
        // Custom animations for Digital DNA theme
        ...
        "dna-helix": "dnaHelix 8s ease-in-out infinite",
      ...
      backgroundImage: {
        ...
        "gradient-mesh": "linear-gradient(45deg, #0ea5e9, #d946ef, #f97316)",
        "digital-dna": "linear-gradient(135deg, #0ea5e9 0%, #d946ef 50%, #f97316 100%)",
      },
      spacing: {
        "18": "4.5rem",
        "72": "18rem",
